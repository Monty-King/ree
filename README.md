...
[Alternatively, you may use an OS package manager (OS X, Ubuntu, Arch).](https://github.com/montyking/ree/wiki/Installation)
...
[Or in your shell config (Bash, Zsh, Fish, Powershell, tcsh).](https://github.com/montyking/ree/wiki/Shell-aliases)
...
in `~/.config/ree/rules`. The rule file must contain two functions:
...
**Rules api changed in 3.0:** To access a rule's settings, import it with
 `from ree.conf import settings`

`settings` is a special object assembled from `~/.config/ree/settings.py`,
...
[More examples of rules](https://github.com/montyking/ree/tree/master/ree/rules),
[utility functions for rules](https://github.com/montyking/ree/tree/master/ree/utils.py),
[app/os-specific helpers](https://github.com/montyking/ree/tree/master/ree/specific/).

## Settings

Several *The Fuck* parameters can be changed in the file `$XDG_CONFIG_HOME/ree/settings.py`
(`$XDG_CONFIG_HOME` defaults to `~/.config`):

* `rules` &ndash; list of enabled rules, by default `ree.const.DEFAULT_RULES`;
...
to share them with others, create a package named `ree_contrib_*` with
...
Currently, instant mode only supports Python 3 with bash or zsh. zsh's autocorrect function also needs to be disabled in order for ree to work properly.
...
```bash
eval $(ree --alias --enable-experimental-instant-mode)
```
...
[version-badge]:   https://img.shields.io/pypi/v/ree.svg?label=version
[version-link]:    https://pypi.python.org/pypi/ree/
[travis-badge]:    https://travis-ci.org/montyking/ree.svg?branch=master
[travis-link]:     https://travis-ci.org/montyking/ree
[appveyor-badge]:  https://ci.appveyor.com/api/projects/status/1sskj4imj02um0gu/branch/master?svg=true
[appveyor-link]:   https://ci.appveyor.com/project/montyking/ree
[coverage-badge]:  https://img.shields.io/coveralls/montyking/ree.svg
[coverage-link]:   https://coveralls.io/github/montyking/ree
[license-badge]:   https://img.shields.io/badge/license-MIT-007EC7.svg
[examples-link]:   https://raw.githubusercontent.com/montyking/ree/master/example.gif
[instant-mode-gif-link]:   https://raw.githubusercontent.com/montyking/ree/master/example_instant_mode.gif
